...
namespace MedicalSystem.Api.Services
{
                ...
                var claims = new List<Claim>()
        {
            ...
            {
                Subject = new ClaimsIdentity(new[] { new Claim(ClaimTypes.Name, user.UserName), new Claim(ClaimTypes.Role, "Patient") }),
        ...
        //		  });
        public async Task<JwtSecurityToken> CreateJwtToken(User user, string role)
        {
            string key = _jwt.Key;
